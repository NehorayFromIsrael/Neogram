...
"""
# - use this template to create inline functions in your bot , variables and functions are listed down below - #

* Inline function is function you can activate when inline button is pressed ,
 the function name is the name you gave to the function file(not include the .py extinction)
"""
