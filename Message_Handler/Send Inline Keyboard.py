...
Send.Inline_Keyboard(Bot_Variables, "Text Here" ,
    ...
    Send.Inline_Keyboard(Bot_Variables, "Text Here" ,
                         Button.Inline(  ["U","URL Button","https://www.google.co.il/"] ,  ["C","Callback Button","Inline Example"] ) ,
                         Button.Inline(["C","Callback Button","Inline Example"] ,["U","URL Button","https://www.google.co.il/"])
                         )